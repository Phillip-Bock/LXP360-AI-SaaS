    ...
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-[#001d3d] mb-4">Analytics</h1>
          <p className="text-[#003066] text-lg">Designer data capture, pricing/contracts, bug/feature requests</p>

          <div className="mt-8">
            <PageNavigation
              previousPage={{ href: "/workspace", label: "Workspace" }}
              nextPage={{ href: "/project-initiation", label: "Project Initiation" }}
            />
          </div>
        </div>
      </main>
