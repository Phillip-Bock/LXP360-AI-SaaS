...
export default function ICESToolsPage() {
  return (
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-[#001d3d] mb-4">ICES Tools</h1>
          <p className="text-[#003066] text-lg">Intelligent Cognitive Engagement System</p>
        </div>
      </main>
    </div>
  )
