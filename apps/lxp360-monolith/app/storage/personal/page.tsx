    ...
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-[#001d3d] mb-4">Personal Storage</h1>
          <p className="text-[#003066] text-lg">Connects to private G-Drive</p>

          <div className="mt-8">
            <PageNavigation
              previousPage={{ href: "/resources", label: "Resources" }}
              nextPage={{ href: "/storage/team", label: "Team Storage" }}
            />
          </div>
        </div>
      </main>
