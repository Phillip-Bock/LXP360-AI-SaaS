...
export function TitleWithParagraph() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.1)] p-10 w-full max-w-[800px] mx-auto my-5">
      <h1
        ...
        className="text-[2.5em] font-bold m-0 mb-5 p-2.5 outline-none border-2 border-transparent transition-[border-color] duration-300 focus:border-[#667eea]"
      >
        Title with a Paragraph Below
      </h1>
      <div
        className="text-right text-[0.9em] mt-2"
        style={{ color: titleCharCount >= maxTitleChars ? "#e0245e" : "#606770" }}
      >
      ...
      <div className="flex flex-wrap bg-[#f8f9fa] border border-[#dee2e6] rounded-lg p-1.5 mb-2.5">
        <div className="flex mr-2.5 pr-2.5 border-r border-[#dee2e6]">
          <button
            title="Bold"
            className="bg-none border-none p-2 cursor-pointer rounded hover:bg-[#e9ecef] transition-colors"
          >
            <b>B</b>
          </button>
          <button
