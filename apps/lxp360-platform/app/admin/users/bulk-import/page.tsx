...
import { FileCsv, Users, Warning } from "@phosphor-icons/react"
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-[#0056B8]/20 flex items-center justify-center">
                  <FileCsv className="w-5 h-5 text-[#019EF3]" weight="duotone" />
                </div>
                <div>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-[#FF781F]/20 flex items-center justify-center">
                  <Warning className="w-5 h-5 text-[#FF781F]" weight="duotone" />
                </div>
                <div>
